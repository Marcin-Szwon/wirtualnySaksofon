...
let audio = new Audio("sound/C4.mp4");
...
A3Sharp.addEventListener("click", function () {
  playMusic("A3SHARP.mp4", "A3SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
...
H3.addEventListener("click", function () {
  playMusic("H3.mp4", "H3_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
C4.addEventListener("click", function () {
  playMusic("C4.mp4", "C4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
C4Sharp.addEventListener("click", function () {
  playMusic("C4SHARP.mp4", "C4SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
D4.addEventListener("click", function () {
  playMusic("D4.mp4", "D4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
D4Sharp.addEventListener("click", function () {
  playMusic("D4SHARP.mp4", "D4SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
E4.addEventListener("click", function () {
  playMusic("E4.mp4", "E4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
F4.addEventListener("click", function () {
  playMusic("F4.mp4", "F4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
F4Sharp.addEventListener("click", function () {
  playMusic("F4SHARP.mp4", "F4SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
G4.addEventListener("click", function () {
  playMusic("G4.mp4", "G4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
G4Sharp.addEventListener("click", function () {
  playMusic("G4SHARP.mp4", "G4SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
A4.addEventListener("click", function () {
  playMusic("A4.mp4", "A4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
A4Sharp.addEventListener("click", function () {
  playMusic("A4SHARP.mp4", "A4SHARP_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
H4.addEventListener("click", function () {
  playMusic("H4.mp4", "H4_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
C5.addEventListener("click", function () {
  playMusic("C5.mp4", "C5_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
C5Sharp.addEventListener("click", function () {
  playMusic("C5SHARP.mp4", "PUSTY_FRONT.png", "PUSTY_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
D5.addEventListener("click", function () {
  playMusic("D5.mp4", "D4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
D5Sharp.addEventListener("click", function () {
  playMusic("D5SHARP.mp4", "D4SHARP_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
E5.addEventListener("click", function () {
  playMusic("E5.mp4", "E4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
F5.addEventListener("click", function () {
  playMusic("F5.mp4", "F4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
F5Sharp.addEventListener("click", function () {
  playMusic("F5SHARP.mp4", "F4SHARP_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
G5.addEventListener("click", function () {
  playMusic("G5.mp4", "G4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
G5Sharp.addEventListener("click", function () {
  playMusic("G5SHARP.mp4", "G4SHARP_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
A5.addEventListener("click", function () {
  playMusic("A5.mp4", "A4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
A5Sharp.addEventListener("click", function () {
  playMusic("A5SHARP.mp4", "A4SHARP_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
H5.addEventListener("click", function () {
  playMusic("H5.mp4", "H4_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
...
C6.addEventListener("click", function () {
  playMusic("C6.mp4", "C5_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === "." || event.key === ">") {
...
C6Sharp.addEventListener("click", function () {
  playMusic("C6SHARP.mp4", "PUSTY_FRONT.png", "OKTAWA_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === ";" || event.key === ":") {
...
D6.addEventListener("click", function () {
  playMusic("D6.mp4", "PUSTY_FRONT.png", "D6_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === "[" || event.key === "{") {
...
D6Sharp.addEventListener("click", function () {
  playMusic("D6SHARP.mp4", "PUSTY_FRONT.png", "D6SHARP_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === "]" || event.key === "}") {
...
E6.addEventListener("click", function () {
  playMusic("E6.mp4", "E6_FRONT.png", "E6_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === "'" || event.key === "'") {
...
F6.addEventListener("click", function () {
  playMusic("F6.mp4", "E6_FRONT.png", "F6_BACK.png");
  changeColor(this);
});
document.addEventListener("keydown", function (event) {
  if (event.key === "/" || event.key === "?") {
